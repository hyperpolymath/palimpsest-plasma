...
// Replace palimpsest-plasma, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= palimpsest-plasma — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining palimpsest-plasma for
...
podman build -t palimpsest-plasma .
----
...
* Upstream: https://github.com/hyperpolymath/palimpsest-plasma/issues
