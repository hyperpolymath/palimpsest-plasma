...
// Replace palimpsest-plasma, Palimpsest Plasma — See README.adoc for details., just run, Palimpsest Plasma started successfully. with actuals
= palimpsest-plasma — Quick Start for Users
:toc:
:toclevels: 2

== What is palimpsest-plasma?

Palimpsest Plasma — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./palimpsest-plasma-portable
----
...
[source]
----
Palimpsest Plasma started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/palimpsest-plasma/wiki
