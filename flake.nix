{
  description = "palimpsest-plasma - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 palimpsest-plasma development environment"
            echo "Language: rust"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P palimpsest-plasma.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/palimpsest-plasma $out/bin/  # Rust
            # cp bin/palimpsest-plasma $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/palimpsest-plasma";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-palimpsest-plasma" {
